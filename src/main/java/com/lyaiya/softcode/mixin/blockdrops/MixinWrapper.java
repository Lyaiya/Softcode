...
abstract class MixinWrapper {
    ...
    private String modifyConstantMin(String constant) {
        String key = Util.getKey(ModIdConstant.BLOCK_DROPS, KeyConstant.GUI, "min");
    ...
    private String modifyConstantMax(String constant) {
        String key = Util.getKey(ModIdConstant.BLOCK_DROPS, KeyConstant.GUI, "max");
        return I18n.format(key);
    }
    ...
    private String modifyConstantTooManyDrops(String constant) {
        String key = Util.getKey(ModIdConstant.BLOCK_DROPS, KeyConstant.GUI, "too_many_drops");
        return I18n.format(key);
    }
}
