...
private fun modifyConstantKey0(text: String): String {
    return I18n.format(getTranslationKey(ModIdConstant.IC2, KeyConstant.KEY, "alt_key"))
}
...
private fun modifyConstantKey1(text: String): String {
    return I18n.format(getTranslationKey(ModIdConstant.IC2, KeyConstant.KEY, "boost_key"))
}
...
private fun modifyConstantKey2(text: String): String {
    return I18n.format(getTranslationKey(ModIdConstant.IC2, KeyConstant.KEY, "mode_switch_key"))
}
...
private fun modifyConstantKey3(text: String): String {
    return I18n.format(getTranslationKey(ModIdConstant.IC2, KeyConstant.KEY, "side_inventory_key"))
}
...
private fun modifyConstantKey4(text: String): String {
    return I18n.format(getTranslationKey(ModIdConstant.IC2, KeyConstant.KEY, "hud_expand_key"))
}