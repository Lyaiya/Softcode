...
abstract class MixinKeyboardClient {
    ...
    private String modifyConstantInit0(String constant) {
        String key = Util.getKey(ModIdConstant.IC2, KeyConstant.KEY, "alt");
    ...
    private String modifyConstantInit1(String constant) {
        String key = Util.getKey(ModIdConstant.IC2, KeyConstant.KEY, "boost");
        return I18n.format(key);
    }
    ...
    private String modifyConstantInit2(String constant) {
        String key = Util.getKey(ModIdConstant.IC2, KeyConstant.KEY, "mode_switch");
        return I18n.format(key);
    }
    ...
    private String modifyConstantInit3(String constant) {
        String key = Util.getKey(ModIdConstant.IC2, KeyConstant.KEY, "side_inventory");
        return I18n.format(key);
    }
    ...
    private String modifyConstantInit4(String constant) {
        String key = Util.getKey(ModIdConstant.IC2, KeyConstant.KEY, "hud_expand");
        return I18n.format(key);
    }
}
