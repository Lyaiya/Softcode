...
abstract class MixinEnumSortingType {
    ...
    private String modifyConstantDefault(String constant) {
        String key = Util.getKey(ModIdConstant.CONTROLLING, KeyConstant.KEY, "default");
    ...
    private String modifyConstantAZ(String constant) {
        String key = Util.getKey(ModIdConstant.CONTROLLING, KeyConstant.KEY, "a_z");
        return I18n.format(key);
    }
    ...
    private String modifyConstantZA(String constant) {
        String key = Util.getKey(ModIdConstant.CONTROLLING, KeyConstant.KEY, "z_a");
        return I18n.format(key);
    }
}
