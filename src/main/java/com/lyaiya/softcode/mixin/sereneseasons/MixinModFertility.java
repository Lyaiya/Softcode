...
abstract class MixinModFertility {
    ...
    private static String modifyConstantFertileSeason(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "fertile_seasons");
    ...
    private static String modifyConstantYearRound(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "year_round");
        return I18n.format(key);
    }
    ...
    private static String modifyConstantSpring(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "spring");
        return I18n.format(key);
    }
    ...
    private static String modifyConstantSummer(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "summer");
        return I18n.format(key);
    }
    ...
    private static String modifyConstantAutumn(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "autumn");
        return I18n.format(key);
    }
    ...
    private static String modifyConstantWinter(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.SERENES_SEASONS, KeyConstant.DESC, "winter");
        return I18n.format(key);
    }
}
