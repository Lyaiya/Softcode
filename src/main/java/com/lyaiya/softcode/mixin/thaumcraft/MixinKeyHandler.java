...
abstract class MixinKeyHandler {
    ...
    private static String modifyConstantKeyF(String constant) {
        String key = Util.getKey(ModIdConstant.THAUMCRAFT, KeyConstant.KEY, "change_caster_focus");
    ...
    private static String modifyConstantKeyG(String constant) {
        String key = Util.getKey(ModIdConstant.THAUMCRAFT, KeyConstant.KEY, "misc_caster_toggle");
        return I18n.format(key);
    }
}
