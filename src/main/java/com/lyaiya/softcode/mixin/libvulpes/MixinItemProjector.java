...
abstract class MixinItemProjector {
    ...
    private String modifyConstantShiftRightClick(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "projector", "shift_right_click");
    ...
    private String modifyConstantShiftScroll(String constant) {
        String key = TranslationKeyKt.create(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "projector", "shift_scroll");
        return I18n.format(key);
    }
}
