...
abstract class MixinItemLinker {
    ...
    private String modifyConstantCoordsUnset(String constant) {
        String key = Util.getKey(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "linker", "coords_unset");
    ...
    private String modifyConstantX(String constant) {
        String key = Util.getKey(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "linker", "x");
        return I18n.format(key);
    }
    ...
    private String modifyConstantY(String constant) {
        String key = Util.getKey(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "linker", "y");
        return I18n.format(key);
    }
    ...
    private String modifyConstantZ(String constant) {
        String key = Util.getKey(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "linker", "z");
        return I18n.format(key);
    }
    ...
    private String modifyConstantDim(String constant) {
        String key = Util.getKey(ModIdConstant.LIB_VULPES, KeyConstant.TOOLTIP, "linker", "dim");
        return I18n.format(key);
    }
}
